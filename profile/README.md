Twist is an alternative package build machinery for [GNU Emacs][emacs]. It uses [the Nix package manager][nix] to build packages, to ensure reproducible builds of an Emacs configuration.
